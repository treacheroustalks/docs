...
If user sends  ``HELP'' or any unknown command to our component, it will return the
 list of all valid commands. All commands can be found in appendix\ref{list of all commands}. 
...
see\ref{example commands}. If the user enters some text before the command keyword 
...
Appendix D contains more detailed information on interaction through the text
based interfaces.
