...
get all messages that are sent to this domian.  
...
\subsection{Riak}
\label{sec:riak}
\todo{more details on how riak works}
\todo{reference to explain CAP controls}
\todo{explain, what a node is}
...
searched along with search schema which specifies how the object is to be indexed. \todo{``Bucket'': either explain or don't use}
